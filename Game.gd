...
#	if (!map[start_position.x-1][start_position.y] == Tile.DOOR
#	 or !map[start_position.x+1][start_position.y] == Tile.DOOR
#	 or !map[start_position.x][start_position.y-1] == Tile.DOOR
#	 or !map[start_position.x][start_position.y+1] == Tile.DOOR):
